...
/**
 * Created by zouwanli on 16/6/10.
 */
@Slf4j
...
//        return get(url,queries,headers,null,null);
//    }
//    /**
//     * get
//     *
...
//     * @throws IOException
//     */
//    public String get(String url, Map<String, String> queries, Map<String, String> headers,ProxyServerInfo proxyInfo,HttpHost proxy) throws Exception {
//        String responseBody = "";
//
...
//            // 请求数据
//            if(proxyInfo != null && StringUtils.isNotBlank(proxyInfo.getIpaddr())){
//                // socks代理地址
//                InetSocketAddress socksaddr = new InetSocketAddress(proxyInfo.getIpaddr(), proxyInfo.getPort());
...
//        return post(url,queries,params,headers,null);
//    }
//    /**
//     * post
//     *
...
//     * @throws IOException
//     */
//    public String post(String url, Map<String, String> queries, Map<String, String> params, Map<String, String> headers,ProxyServerInfo proxyInfo) throws IOException {
//        String responseBody = "";
//
//
//        StringBuilder sb = new StringBuilder(url);
...
//    }
//
//    public CloseableHttpResponse post(String url, Map<String, String> queries, HttpEntity httpEntity, Map<String, String> headers) throws IOException {
//
//        StringBuilder sb = new StringBuilder(url);
//
//        if (queries != null && queries.keySet().size() > 0) {
...
//    }
//
//    public void postDownLoad(String url, Map<String, String> queries, Map<String, String> params, Map<String, String> headers, String localFileName,ProxyServerInfo proxyInfo) throws IOException {
//        InputStream in = null;
